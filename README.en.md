...
Each of the 82 Panels preserves its own original brief and aesthetic logic. The table continuously lists every project from 001 through 082 with its defining style characteristics; the current project is bold.
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–082) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
