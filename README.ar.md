...
# 🦁 XXD Panel 082｜ألوان مائية تقفز من الورق

### يخرج البطل الأساسي من حقل مائي غير منتظم
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 082 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يميل الرسم الطفولي المسطح إلى أن يصبح كملصق، بينما يفقد 3D الواقعي تنفس الألوان المائية. وإذا لم يُختزل المشهد المعقد، يختفي البطل المركزي واستعارة الصورة.

يضغط **Panel 082** الصورة في حقول مائية كبيرة غير منتظمة، ثم ينهض ببطل واحد منها عبر محيط Naïve + Wonky وبنية Isometric／2.5D واضحة. تصنع السطوح المتراكبة والحجب وفروق الارتفاع الفضاء، وتحفظ ألوان الأصل الحية والفراغات البيضاء الدافئة الهواء والطفولة.

### مناسب لـ

- جعل عنصر واحد يقفز من حقل ألوان مائية غير منتظم بعمق Isometric／2.5D؛
- الحفاظ على طفولة Naïve + Wonky من دون فقدان الاتجاه والطبقات والمنطق المكاني؛
- اختزال الصور المعقدة إلى الهوية والاستعارة وأكثر ألوان الأصل حياةً؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 082 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** حقل مائي غير منتظم · Naïve + Wonky · Isometric／2.5D · محيط طفولي · ألوان حية مريحة · عالم مجسّم صغير
...
|---|---|
| **الناتج** | ملصق كتاب مصور راقٍ ينهض بطله المجسّم من سطح مائي ناعم |
| **البصمة الواضحة** | ألوان مائية غير منتظمة، محيطات ساذجة، اتجاه محوري واضح، سطوح متراكبة، وفراغ واسع |
| **احترام المصدر** | يحتفظ بأقوى سمات الهوية والاستعارة ويعيد ضبط أكثر ألوان الأصل سطوعاً وحيويةً |
...
```text
استخلاص الهوية والبنية والوضع والاستعارة → ضغط المشهد في حقول مائية غير منتظمة → تحديد بطل Naïve + Wonky واحد → بناء عمق Isometric／2.5D بالسطوح والمقاطع والحجب → إعادة ضبط ألوان الأصل الأكثر حياةً → حفظ الفراغ الأبيض الدافئ → وضع نص تحريري قليل بمحاذاة الحقول والمحاور
```

## سمات النتيجة النهائية

- تظهر في الحقول المائية الكبيرة آثار الماء والحبيبات والشفافية والانزياح الخفيف.
- ينهض بطل واحد من الحقل المسطح بالاتجاه المحوري والسطوح المتراكبة والحجب.
- تضبط براءة النسب وارتجاف المحيطات بمنطق مكاني Isometric واضح.
- تأتي الألوان من أكثر أجزاء الأصل حياةً، بخلفية أنعم وألوان رئيسة أكثر تماسكاً للبطل.
- تُحذف البيئة المعقدة ليتحكم الشكل الموجب والسالب والهواء ومركز بصري واحد في الصفحة.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-082-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 082. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-082 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-082 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-082 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-082 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-082 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 082 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-082 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-082`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-082-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-082-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ82 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 082 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–082) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
